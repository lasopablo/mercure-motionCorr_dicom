...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.1-static"
  WORKING_DIRECTORY "/home/micsipc/github/mercure-motionCorr_dicom/build/openjpeg"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v2.1-static" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v2.1-static")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/micsipc/github/mercure-motionCorr_dicom/build/openjpeg'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/micsipc/github/mercure-motionCorr_dicom/build/openjpeg'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
